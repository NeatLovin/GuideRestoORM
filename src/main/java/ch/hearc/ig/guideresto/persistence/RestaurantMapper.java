...
public class RestaurantMapper extends AbstractMapper<Restaurant> {
    ...
    public Set<Restaurant> findByName(String name) {
        if (name == null) return new LinkedHashSet<>();
    ...
    public Set<Restaurant> findByCityName(String cityName) {
        if (cityName == null) return new LinkedHashSet<>();
    ...
    public Set<Restaurant> findByType(int typeId) {
        TypedQuery<Restaurant> query = em.createQuery("SELECT r FROM Restaurant r WHERE r.type.id = :typeId ORDER BY r.name", Restaurant.class);
